...
#define   MAXIMO     100  // Límite máximo de los arreglos de caracteres que se usarán
...
{
	// Paso 1: crear un nuevo nodo, y hacer que un puntero auxiliar apunte hacia el nodo
	temp = (struct Nodo*) calloc(1, sizeof(struct Nodo));
	
	// Paso 2: llenar el nuevo nodo con los datos de la nueva canción
...
void imprimir_base_datos( )
{
	...
	temp = inicio;    // Se comienza a recorrer la pila desde el principio (desde "cabecera")
